...
int Preprocessing::setGaborParams(int blockSize, double gaborLambda, double gaborSigma, double gaborGamma, double gaborPsi) {

    if (m_preprocessingIsRunning) {
        preprocessingError(10);
        return -1;
    }
    m_gaborParams.gamma = gaborGamma;
    m_gaborParams.psi = gaborPsi;
    setPreprocessingParams(blockSize, gaborLambda, gaborSigma);
    return 1;
}
